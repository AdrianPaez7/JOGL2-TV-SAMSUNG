...
public class MyCanvas extends GLCanvas implements GLEventListener, KeyListener {
    ...
    public void init(GLAutoDrawable glad) {
        ...
        try {
            obj1 = or.Load("./data/Samsung LED TV.obj");
        ...
        /*
        try {
            obj2 = or.Load("./data/chair55.obj");
            System.out.println("Objeto 2 cargado :" + this.fileName);
        } catch (IOException ioe) {
            System.out.println(ioe.getMessage());
        }        
        
        try {
            obj3 = or.Load("./data/table_c.obj");
            System.out.println("Objeto 3 cargado :" + this.fileName);
        } catch (IOException ioe) {
            System.out.println(ioe.getMessage());
        }       
        */
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (e.isShiftDown()) {  // SHIFT y Flechas controlan la LUZ
            switch (cod) {
                ...
                case KeyEvent.VK_SUBTRACT:  // Zoom In
                    plz -= 1;
                    break;
